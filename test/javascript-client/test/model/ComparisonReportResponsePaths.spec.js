...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RestApiQualityApi.ComparisonReportResponsePaths();
  });
  ...
  describe('ComparisonReportResponsePaths', function() {
    it('should create an instance of ComparisonReportResponsePaths', function() {
      // uncomment below and update the code to test ComparisonReportResponsePaths
      //var instane = new RestApiQualityApi.ComparisonReportResponsePaths();
      //expect(instance).to.be.a(RestApiQualityApi.ComparisonReportResponsePaths);
    });
