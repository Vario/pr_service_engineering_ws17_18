...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RestApiQualityApi.ChangeItem();
  });
  ...
  describe('ChangeItem', function() {
    it('should create an instance of ChangeItem', function() {
      // uncomment below and update the code to test ChangeItem
      //var instane = new RestApiQualityApi.ChangeItem();
      //expect(instance).to.be.a(RestApiQualityApi.ChangeItem);
    });
